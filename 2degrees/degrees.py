...
# add: input 1: Emma Watson, input 2: Jennifer Lawrence and wait few mins.
...
def shortest_path(source, target):
    ...
    while not frontier.empty():
        ...
        visited.add(node.state) # adds the state of the node that was removed from the frontier to the visited set
